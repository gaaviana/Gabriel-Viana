    ...
    return <section id="testimonials" className=" py-32 relative overflow-hidden">
        <div className="container mx-auto px-6 relative z-10">
            <div className="text-center mx-auto max-w-3xl mb-16">
                <span className="text-cor-secundaria-texto text-sm font-medium -tracking-wider uppercase fade-in">O que as pessoas dizem</span>
                <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6 fade-in delay-100 text-cor-secundaria-texto">Palavras gentis de <span className="font-serif italic font-normal text-white">pessoas incríveis.</span></h2>
            </div>
            ...
            <div className="flex items-center justify-center gap-4 mt-8">
                <button className="p-3 rounded-full vidro hover:bg-cor-primaria/10 hover:text-cor-primaria transition-all" onClick={anterior}> <ChevronLeft/> </button>
                ...
                <button className="p-3 rounded-full vidro hover:bg-cor-primaria/10 hover:text-cor-primaria transition-all" onClick={proximo}> <ChevronRight/> </button>
            </div>
        </div>
    </section>
}
